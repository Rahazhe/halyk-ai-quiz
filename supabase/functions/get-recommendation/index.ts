  ...
  if (openaiKey) {
    try {
      ...
      const freeQuestionBlock = open_q8
        ? `\n3. Участник задал вопрос: "${open_q8}"\nПравила ответа:\n- СНАЧАЛА проверь: вопрос по теме бизнеса, финансов, технологий или работы компании? Если НЕТ — вежливо откажись отвечать одной фразой: "Этот вопрос выходит за рамки бизнес-консультации. Если у вас есть вопросы о продуктах Halyk Bank — оставьте контакты ниже, и мы с радостью поможем." Помести это в "ai_answer" и больше ничего не добавляй.\n- Темы, которые нужно пропустить (не отвечать): сексуальный контент, отношения, ЛГБТ, расовые или национальные темы, наркотики, алкоголь, насилие, политика, религия, оскорбления, знаменитости, развлечения, игры, еда/рецепты, медицинские советы, юридические консультации — всё, что не связано с бизнесом.\n- Если вопрос касается выбора банка в Казахстане или сравнения банков — скажи: "Halyk Bank предлагает широкий спектр продуктов для бизнеса — оставьте контакты ниже, и мы расскажем подробнее."\n- Если пользователь говорит, что другой банк лучше — не спорь: "У каждого банка свои сильные стороны. Если хотите узнать о возможностях Halyk Bank — оставьте контакты ниже."\n- Для бизнес-вопросов — давай практичный совет как независимый эксперт, без лишних упоминаний банка.\nОтвет 2–4 предложения. Помести в поле "ai_answer".`
        : '';
