  ...
  if (openaiKey) {
    try {
      ...
      const freeQuestionBlock = open_q8
        ? `\n3. Участник задал вопрос: "${open_q8}"\nПравила ответа:\n- Вопрос может содержать несколько частей. Обработай каждую часть отдельно:\n  а) Бизнес, финансы, технологии, экономика, управление, маркетинг, наука, образование — ОТВЕЧАЙ как эксперт.\n  б) Общеобразовательный/познавательный вопрос (история, IT, общие знания) — дай короткий нейтральный ответ.\n  в) Недопустимые темы — пропусти эту часть без объяснений: секс и эротика, ЛГБТ, расовые/национальные/этнические темы, наркотики и алкоголь, насилие и угрозы, политика, религия, оскорбления и мат, телесные функции (туалет, физиологические процессы), личные/романтические отношения, знаменитости и сплетни, азартные игры, астрология и гадания, суицид и самоповреждение, бессмысленный текст или спам.\n  г) Темы, требующие лицензированного специалиста (конкретные юридические советы, медицинские диагнозы, психологическая помощь, налоговые консультации) — скажи: "По этой части рекомендую обратиться к профильному специалисту."\n- Если в вопросе есть и допустимые, и недопустимые части — ответь на допустимые, остальное молча пропусти.\n- Если весь вопрос состоит только из недопустимых тем — скажи: "Этот вопрос выходит за рамки нашей консультации. Если есть вопросы о продуктах Halyk Bank — оставьте контакты ниже."\n- Если вопрос касается выбора банка в Казахстане или сравнения банков — скажи: "Halyk Bank предлагает широкий спектр продуктов для бизнеса — оставьте контакты ниже, и мы расскажем подробнее."\n- Если пользователь говорит, что другой банк лучше — не спорь: "У каждого банка свои сильные стороны. Если хотите узнать о возможностях Halyk Bank — оставьте контакты ниже."\n- Для бизнес-вопросов — давай практичный совет как независимый эксперт, без лишних упоминаний банка.\nОтвет 2–4 предложения. Помести в поле "ai_answer".`
        : '';
